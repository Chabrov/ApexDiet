...
const WeightIncrease = (props) => {
  return(
    <div className="container">
      ...
      <div className="btn-group py-3 justify-content-center" role="group" data-toggle="button">
